...
elim=$(sed -n 31p comandos/parametros_globk.txt)
...
#AÑO 2
"$nano2"
#NUMERO DE ESTACIONES REFERENCIA
"$nnerf"
#PARAMETRO DE SELECCION DE ESTACIONES DE REFERENCIA
"$npser"
#MEJORES ESTACIONES
"$esta"
#MODELO
"$nmodex"
#ESTACIONES A ELIMINAR(MAX 22)
"$elim"
" > $carpeta/parametros.txt
					cd $carpeta
					./globk_ejecutar.sh
					cd ..
				done
...
echo "Resultaron: "$contador" resultados posibles"
