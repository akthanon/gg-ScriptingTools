...
rm -r resultados/$new_resultado
mkdir resultados/$new_resultado
mkdir resultados/$new_resultado/series
mkdir resultados/$new_resultado/vsoln
mkdir resultados/$new_resultado/datos
mkdir resultados/$new_resultado/graficas
mv series/* resultados/$new_resultado/series
mv vsoln/* resultados/$new_resultado/vsoln
mv datos/* resultados/$new_resultado/datos
mv graficas/* resultados/$new_resultado/graficas
mv exme.ps resultados/$new_resultado
